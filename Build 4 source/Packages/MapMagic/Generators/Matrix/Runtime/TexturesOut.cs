...
namespace MapMagic.Nodes.MatrixGenerators {
	...
	[System.Serializable]
	public abstract class BaseTexturesOutput<L> : Generator, IMultiInlet, IMultiOutlet, IOutputGenerator, IInvLayered<L> where L: BaseTextureLayer, new()
	{
	...
	public class CustomShaderOutput200 : BaseTexturesOutput<CustomShaderOutput200.CustomShaderLayer>
	{
		...
		{
			Color[][] colors = new Color[matrices.Length/4 + 1][];
	...
	{
		#if RTP
		private ReliefTerrain rtp = null;
		#endif
...
//			CustomShaderOutput200.BlendControlTextures(ref colors, typeof(RTPOutput200), data);
			...
			var controlTexturesData = new CustomShaderOutput200.ApplyData() {
				...
				textureFormat = TextureFormat.RGBA32,
				textureBaseMapDistance = 10000000, //no base map
				textureNames = new string[colors.Length] };
