...
Shader "MicroSplat/MicroSplat" {
   Properties {
      ...
      [HideInInspector] _CustomControl2 ("Control2", 2D) = "black" {}
      [HideInInspector] _CustomControl3 ("Control3", 2D) = "black" {}
   ...
   SubShader {
      Tags{ "RenderType" = "Opaque"  "Queue" = "Geometry+100" "SplatCount" = "16"}
      Cull Back
      ZTest LEqual
      ...
      void SampleNormal(Config config, TriplanarConfig tc, inout RawSamples s, MIPFORMAT mipLevel, half4 weights)
      {
         ...
         return;
            ...
            
            {
               ...
               // for some reason, this first branch causes all hell to break loose when distance resampling is enabled.
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/MicroSplat_Base-723625388"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/MicroSplat_Base-723625388"
