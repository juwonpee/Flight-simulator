...
public class MissileAero : MonoBehaviour {
    ...
    private void FixedUpdate() {
        ...
        Vector3 velocityPrediction = PredictVelocity(forceAndTorqueThisFrame.p + transform.forward * thrust + Physics.gravity * rb.mass);
