...
namespace MapMagic.Nodes.GUI
{
	public static class GraphPopup
	{
			...
			public static Item GraphItems (Graph graph, int priority=1)
			{
				...
				Item importItem = new Item("Import", onDraw:RightClick.DrawItem, priority:9) { icon = RightClick.texturesCache.GetTexture("MapMagic/Popup/Import"), color = Color.gray };
				importItem.onClick = ()=>
				{
				...
				Item exportItem = new Item("Export", onDraw:RightClick.DrawItem, priority:9) { icon = RightClick.texturesCache.GetTexture("MapMagic/Popup/Export"), color = Color.gray };
				...
				graphItems.subItems.Add( new Item("Update All", onDraw:RightClick.DrawItem, priority:7) { icon = RightClick.texturesCache.GetTexture("MapMagic/Popup/Update"), color = Color.gray } );
