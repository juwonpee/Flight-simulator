...
namespace Den.Tools
{
	...
	public static class Serializer
	{
		...
		public class Object
		{
			...
			public static Object Null {get{ return new Object() { refId=-1 }; }}
		}
		...
		/// Will try to get object from reuse at the same position first. Note that reuse exists before the serialization and deserialized objs have no fields loaded, but to the end deserialised and reuse members are equal.
		{
			...
			if (type == null)
				...
				//{ Debug.LogWarning("Could not find type for: " + serObj.type); return null; }
				//return null;
		...
		{
			public Serializer.Object[] serializedObjects = new Serializer.Object[0];
		}
	}
