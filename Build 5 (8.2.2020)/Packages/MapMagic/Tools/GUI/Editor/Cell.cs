...
//		public string name;
		...
		#region Factory / Dispose
			...
			public static Cell GetCell ()
			{
				...
				cell.pixelOffset.x=0;		cell.pixelOffset.y=0;
				cell.pixelSize.x=0;			cell.pixelSize.y=0;
				cell.relativeSize.x=0;		cell.relativeSize.y=0;
				cell.relativeOffset.x=0;	cell.relativeOffset.y=0;
				cell.pixelOffset.x=0;		cell.pixelOffset.y=0;
				cell.stackHor = false;
				cell.stackVer = false;

				//copy properties
				cell.trackChange = current.trackChange;
